...
import UpdateLyric from './components/UpdateLyric/UpdateLyric'
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route 
          path='/lyrics'
          element={<LyricList lyrics={lyrics} user={user} handleDeleteLyric={handleDeleteLyric} handleUpdateLryic={handleUpdateLyric} />}
        />
        <Route
          path="/profiles"
          element={
